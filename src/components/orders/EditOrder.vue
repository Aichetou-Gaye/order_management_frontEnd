        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr v-for="(item, index) in store.details" :key="index">
                    <td><select class="form-select" id="product" v-model="detail.product" required>
                    ...
                    <td><input type="number" class="form-control" min="1" value="1" v-model="detail.quantity" required>
                    </td>
                    <td><input type="number" class="form-control" min="0" value="0" v-model="detail.price" required>
                    </td>
                    <td class="text-center"><button class="btn btn-danger" @click="dropDetail(item)">Remove</button></td>
                </tr>
